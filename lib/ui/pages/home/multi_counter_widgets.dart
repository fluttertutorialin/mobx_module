...
import 'package:mobx_module/stores/multi/multi_counter_store.dart';
...
class _MultiCounterExampleState extends State<MultiCounterExample> {
  final SingleCounter store = SingleCounter();

  @override
  Widget build(BuildContext context) => Provider<SingleCounter>.value(
        value: store,
        child: Scaffold(
          appBar: AppBar(
...
class CounterListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final store = Provider.of<SingleCounter>(context);
